...
const ConsumptionDetails = ({ item }) => {
    ...
    return (
        <DashboardLayout>
            <Head title={`Reparatrion Details - ${data.ville}`} />
            ...
            >
                ...
                Back
                        ...
                        <StatusBadge
                            value={data.consumption_data.status.mission}
                            threshold={0}
                        />
                    </div>
                </motion.div>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="text-xl font-semibold text-gray-900 dark:text-white">
                                    {data.consumption_data.qty_litre || 'N/A'}
                                </p>
                            </div>
                            <div>
                                <p className="text-sm text-gray-500 dark:text-gray-400">Total Price</p>
                                <p className="text-xl font-semibold text-green-600 dark:text-green-400">
                                    {data.consumption_data.full_prix} DH
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="text-xl font-semibold text-gray-900 dark:text-white">
                                    {data.consumption_data.km_proposer} km
                                </p>
                            </div>
                            <div>
                                <p className="text-sm text-gray-500 dark:text-gray-400">Actual KM</p>
                                <p className="text-xl font-semibold text-gray-900 dark:text-white">
                                    {data.consumption_data.km_total} km
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="text-xl font-semibold text-gray-900 dark:text-white">
                                    {data.consumption_data.taux}%
                                </p>
                            </div>
                            <div>
                                <p className="text-sm text-gray-500 dark:text-gray-400">Status</p>
                                <StatusBadge
                                    value={data.consumption_data.status.gazole}
                                    threshold={0}
                                />
                            </div>
                        </div>
